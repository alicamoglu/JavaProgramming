...
public class ArrayListMethods {
    ...
    public static void main(String[] args) {
       ...
       // groceriesList[2] = "Oranges";
        ...
        groceriesList.add(2, "Chicken");         //todo

        System.out.println(groceriesList);

        groceriesList.remove(0);         //todo
        ...
        boolean r2 = numbers.remove( Integer.valueOf(10) );

        System.out.println(r2);           // when an element doesn't exit to remove gives false
