...
public class Hotel$isValidBooleanWithIf$ {
    /*
    ...
    public static void main(String[] args) {
        ...
        double price = 0;
        String roomType = "";
        boolean isValid = true;    //todo to initilize a snippet only in a certain situation
                                   // and we make sth invalid out there running order skips it.
/*        // with if & boolean
        if (valid days && valid people){
            switch ()
            (but without default else invalid )
        }else{
            invalid
        }
        */
