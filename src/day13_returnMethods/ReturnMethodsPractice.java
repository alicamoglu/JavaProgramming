...
public class ReturnMethodsPractice {
    ...
    public static boolean isEven(int num){
        return !isOdd(num);   // todo !methodName (! and other method name!) if other method false meant 💕
      //  return  (num % 2 == 0)? true : false;
    }
    ...
    public static int max(int n1, int n2){
       // return  n1 > n2 ? n1 : n2;
        ...
        if(n1 > n2){          // todo look 2 return in a method
            return  n1;
        }else{
            return n2;
        }
