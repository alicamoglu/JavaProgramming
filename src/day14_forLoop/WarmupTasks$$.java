...
public class WarmupTasks$$ {
    ...
    public static void main(String[] args) {
        ...
        String s1 = "" + true; //"true"//todo String converts everything after (right of) itself to String but before not true that
                                                                      // line 33 37
        String s2 = "" + 'e'; // "e"   char and boolean as well

        System.out.println("--------preparig for overloding-------");
